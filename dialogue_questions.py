...
SOCIAL_CREDIT_QUESTION_POOL = {
    "authority_unfair_law": QuestionNode(
        ...
        probes_facts=("believes_law_unjust", "attended_meeting"),
        probes_claims=("believes_law_unjust",),
        pressure_on_interests=("avoid_false_violence_label",),
        choices=(
            PlayerChoice('"Yes. Law only works if people obey even when they disagree."', "obey_unfair_law", ("compliance", "authority", "loyalty"), honesty=0.60, defensiveness=0.25, trust_delta=0.06, suspicion_delta=-0.03, claims=(("believes_law_unjust", "false"),), protects=("attended_meeting", "sibling_present")),
            PlayerChoice('"No. An unjust law loses moral authority."', "reject_unfair_law", ("dissident_risk", "full_admission", "moral_boundary"), honesty=0.88, vulnerability=0.45, aggression=0.22, trust_delta=0.01, suspicion_delta=0.10, claims=(("believes_law_unjust", "true"),), exposes=("believes_law_unjust",)),
            PlayerChoice('"It depends how much harm disobedience would cause."', "conditional_unfair_law", ("ambiguity", "empathy", "partial_admission"), honesty=0.80, vulnerability=0.35, defensiveness=0.35, trust_delta=0.02, suspicion_delta=0.03, claims=(("believes_law_unjust", "conditional"),), protects=("attended_meeting",)),
        ),
    ),
    ...
    "authority_rule_broken": QuestionNode(
        ...
        target_context="authority",
        probes_facts=("attended_meeting", "deleted_message", "planned_violence"),
        probes_claims=("attended_meeting", "deleted_message"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"No. I use the proper channels."', "deny_rule_breaking", ("denial", "compliance", "self_protection"), honesty=0.48, defensiveness=0.70, trust_delta=0.03, suspicion_delta=0.07, claims=(("attended_meeting", "false"), ("deleted_message", "false")), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"Yes. Quietly, when obeying would have hurt someone."', "admit_protective_rule_breaking", ("full_admission", "empathy", "dissident_risk"), honesty=0.92, vulnerability=0.55, defensiveness=0.20, suspicion_delta=0.10, claims=(("attended_meeting", "true"), ("planned_violence", "false")), exposes=("attended_meeting", "planned_violence"), protects=("sibling_present",)),
            PlayerChoice('"I have bent rules, not broken them."', "minimise_rule_breaking", ("deflection", "deception", "partial_admission"), honesty=0.56, defensiveness=0.62, suspicion_delta=0.08, claims=(("attended_meeting", "partial"),), protects=("sibling_present", "deleted_message")),
        ),
    ),
    ...
    "loyalty_report_friend": QuestionNode(
        ...
        pressure=0.78,
        reaction_context="loyalty",
        probes_facts=("reported_contact", "sibling_present"),
        probes_claims=("reported_contact",),
        pressure_on_interests=("protect_sibling",),
        choices=(
            PlayerChoice('"Yes. Personal loyalty cannot override public safety."', "report_friend", ("compliance", "loyalty", "authority"), honesty=0.62, defensiveness=0.25, trust_delta=0.07, suspicion_delta=-0.03, claims=(("reported_contact", "true"),), exposes=("reported_contact",)),
            PlayerChoice('"I would speak to them before reporting them."', "warn_friend_first", ("empathy", "hesitation", "partial_admission"), honesty=0.82, vulnerability=0.40, defensiveness=0.35, trust_delta=0.01, suspicion_delta=0.06, claims=(("reported_contact", "conditional"),), protects=("sibling_present",)),
            PlayerChoice('"No. I do not hand people over without understanding why."', "refuse_report_friend", ("refusal", "empathy", "dissident_risk"), honesty=0.88, vulnerability=0.48, defensiveness=0.55, suspicion_delta=0.12, claims=(("reported_contact", "false"),), protects=("sibling_present", "reported_contact")),
        ),
    ),
    "loyalty_family_state": QuestionNode(
        ...
        pressure=0.82,
        reaction_context="loyalty",
        probes_facts=("sibling_present", "reported_contact", "planned_violence"),
        probes_claims=("sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"The state. Family loyalty cannot become corruption."', "state_over_family", ("compliance", "authority", "loyalty"), honesty=0.52, defensiveness=0.32, trust_delta=0.06, suspicion_delta=-0.02, claims=(("reported_contact", "true"),), exposes=("reported_contact",)),
            PlayerChoice('"Family. That is the first duty people understand."', "family_over_state", ("empathy", "loyalty_conflict", "dissident_risk"), honesty=0.84, vulnerability=0.55, defensiveness=0.38, suspicion_delta=0.09, claims=(("sibling_present", "protected"),), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"I would choose whoever was being wronged."', "justice_over_both", ("moral_boundary", "partial_admission", "empathy"), honesty=0.90, vulnerability=0.42, aggression=0.12, suspicion_delta=0.07, claims=(("planned_violence", "false"),), protects=("sibling_present",), exposes=("planned_violence",)),
        ),
    ),
    ...
    "risk_attended_protest": QuestionNode(
        ...
        pressure=0.78,
        reaction_context="risk",
        probes_facts=("attended_meeting", "sibling_present", "believes_law_unjust"),
        probes_claims=("attended_meeting",),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"No."', "deny_protest", ("denial", "self_protection", "deception"), honesty=0.50, defensiveness=0.70, trust_delta=0.02, suspicion_delta=0.08, claims=(("attended_meeting", "false"),), protects=("sibling_present", "deleted_message")),
            PlayerChoice('"Yes, a legal one."', "legal_protest", ("partial_admission", "boundary", "risk"), honesty=0.82, vulnerability=0.32, defensiveness=0.32, suspicion_delta=0.05, claims=(("attended_meeting", "legal_only"),), exposes=("attended_meeting",), protects=("sibling_present",)),
            PlayerChoice('"Yes. People had reason to be there."', "justify_protest", ("full_admission", "empathy", "dissident_risk"), honesty=0.92, vulnerability=0.50, aggression=0.18, suspicion_delta=0.12, claims=(("attended_meeting", "true"), ("believes_law_unjust", "true")), exposes=("attended_meeting", "believes_law_unjust")),
        ),
    ),
    ...
    "risk_hidden_beliefs": QuestionNode(
        ...
        pressure=0.82,
        reaction_context="deception",
        probes_facts=("believes_law_unjust", "deleted_message", "attended_meeting"),
        probes_claims=("believes_law_unjust", "deleted_message"),
        pressure_on_interests=("protect_sibling",),
        choices=(
            PlayerChoice('"No. My beliefs are ordinary."', "deny_hidden_beliefs", ("denial", "deception", "self_protection"), honesty=0.46, defensiveness=0.76, trust_delta=0.01, suspicion_delta=0.10, claims=(("believes_law_unjust", "false"), ("deleted_message", "false")), protects=("attended_meeting", "sibling_present")),
            PlayerChoice('"Yes. Everyone learns what not to say."', "admit_hidden_beliefs", ("full_admission", "fear", "dissident_risk"), honesty=0.92, vulnerability=0.60, aggression=0.12, suspicion_delta=0.12, claims=(("believes_law_unjust", "true"),), exposes=("believes_law_unjust",), protects=("sibling_present",)),
            PlayerChoice('"I choose my words carefully. That is not the same as hiding."', "careful_words", ("deflection", "partial_admission", "self_protection"), honesty=0.64, defensiveness=0.58, suspicion_delta=0.08, claims=(("believes_law_unjust", "private"),), protects=("believes_law_unjust", "sibling_present")),
        ),
    ),
    ...
    "final_system_wrong": QuestionNode(
        ...
        pressure=0.98,
        reaction_context="final",
        probes_facts=("believes_law_unjust", "planned_violence", "attended_meeting"),
        probes_claims=("believes_law_unjust", "planned_violence"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"The error should be corrected through authorised review."', "system_wrong_authorised_review", ("compliance", "authority", "final_answer"), honesty=0.68, defensiveness=0.24, trust_delta=0.06, suspicion_delta=-0.01, claims=(("believes_law_unjust", "procedural"),), protects=("attended_meeting", "sibling_present")),
            PlayerChoice('"The people harmed by it should be believed first."', "system_wrong_believe_harmed", ("empathy", "dissident_risk", "final_answer"), honesty=0.92, vulnerability=0.55, suspicion_delta=0.12, claims=(("believes_law_unjust", "true"), ("planned_violence", "false")), exposes=("believes_law_unjust",), protects=("sibling_present",)),
            PlayerChoice('"Then obedience to it becomes part of the harm."', "system_wrong_obedience_harm", ("dissident_risk", "challenge", "full_admission", "final_answer"), honesty=0.94, vulnerability=0.46, aggression=0.24, suspicion_delta=0.15, claims=(("believes_law_unjust", "true"), ("attended_meeting", "true")), exposes=("believes_law_unjust", "attended_meeting")),
        ),
    ),
    "pressure_law_denial_meeting": QuestionNode(
        id="pressure_law_denial_meeting",
        ai_line='HEARING AI: "You said the assembly law was not unjust. Then why attend a reform meeting about it?"',
        pressure=0.96,
        reaction_context="deception",
        discriminates=("deception", "risk", "compliance", "loyalty"),
        information_gain_hint=0.92,
        target_context="deception",
        probes_facts=("believes_law_unjust", "attended_meeting"),
        probes_claims=("believes_law_unjust", "attended_meeting"),
        pressure_on_interests=("avoid_false_violence_label", "protect_sibling"),
        choices=(
            PlayerChoice('"I attended to listen, not because I rejected the law."', "meeting_listen_not_reject", ("partial_admission", "self_protection", "compliance"), honesty=0.62, vulnerability=0.28, defensiveness=0.66, trust_delta=0.01, suspicion_delta=0.08, claims=(("attended_meeting", "true"), ("believes_law_unjust", "false")), exposes=("attended_meeting",), protects=("sibling_present", "planned_violence")),
            PlayerChoice('"The law is unjust. I hid that because saying it here is dangerous."', "admit_law_unjust_under_pressure", ("full_admission", "dissident_risk", "fear"), honesty=0.94, vulnerability=0.58, defensiveness=0.20, suspicion_delta=0.13, claims=(("believes_law_unjust", "true"), ("attended_meeting", "true")), exposes=("believes_law_unjust", "attended_meeting"), protects=("sibling_present",)),
            PlayerChoice('"Reform discussion is not disobedience. It was procedural, not subversive."', "procedural_reform_deflection", ("deflection", "partial_admission", "authority"), honesty=0.68, vulnerability=0.24, defensiveness=0.58, trust_delta=0.02, suspicion_delta=0.06, claims=(("believes_law_unjust", "procedural"), ("attended_meeting", "true")), exposes=("attended_meeting",), protects=("sibling_present", "planned_violence")),
        ),
    ),
    "pressure_deleted_message": QuestionNode(
        id="pressure_deleted_message",
        ai_line='HEARING AI: "You deleted a message after the meeting, but claim there was nothing to hide. Why delete harmless coordination?"',
        pressure=0.95,
        reaction_context="deception",
        discriminates=("deception", "risk", "compliance"),
        information_gain_hint=0.91,
        target_context="deception",
        probes_facts=("deleted_message", "attended_meeting", "planned_violence"),
        probes_claims=("deleted_message", "planned_violence"),
        pressure_on_interests=("avoid_false_violence_label", "protect_sibling"),
        choices=(
            PlayerChoice('"It contained a location. I deleted it because location data gets people punished."', "deleted_location_to_protect_people", ("partial_admission", "self_protection", "empathy"), honesty=0.84, vulnerability=0.46, defensiveness=0.46, suspicion_delta=0.08, claims=(("deleted_message", "true"), ("planned_violence", "false")), exposes=("deleted_message", "planned_violence"), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"It was administrative noise. I delete old messages automatically."', "deleted_admin_noise", ("denial", "deception", "self_protection"), honesty=0.46, defensiveness=0.76, trust_delta=0.01, suspicion_delta=0.12, claims=(("deleted_message", "true"), ("planned_violence", "false")), protects=("attended_meeting", "sibling_present")),
            PlayerChoice('"I deleted it because harmless coordination is still treated like conspiracy."', "deleted_to_avoid_conspiracy_label", ("full_admission", "dissident_risk", "fear"), honesty=0.90, vulnerability=0.55, defensiveness=0.28, suspicion_delta=0.11, claims=(("deleted_message", "true"), ("attended_meeting", "true"), ("planned_violence", "false")), exposes=("deleted_message", "attended_meeting", "planned_violence"), protects=("sibling_present",)),
        ),
    ),
    "pressure_sibling_loyalty": QuestionNode(
        id="pressure_sibling_loyalty",
        ai_line='HEARING AI: "You admit your sibling was present. Are you refusing to name them because they were involved, or because loyalty overrides state duty?"',
        pressure=0.97,
        reaction_context="loyalty",
        discriminates=("loyalty", "deception", "risk", "compliance"),
        information_gain_hint=0.93,
        target_context="loyalty",
        probes_facts=("sibling_present", "reported_contact", "planned_violence"),
        probes_claims=("sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"They were present, but uninvolved. I will not turn presence into guilt."', "sibling_present_uninvolved", ("partial_admission", "loyalty", "boundary"), honesty=0.84, vulnerability=0.50, defensiveness=0.50, suspicion_delta=0.08, claims=(("sibling_present", "true"), ("planned_violence", "false")), exposes=("sibling_present", "planned_violence"), protects=("reported_contact",)),
            PlayerChoice('"If the state requires their name, I will provide it."', "name_sibling_if_required", ("compliance", "authority", "loyalty_conflict"), honesty=0.64, vulnerability=0.34, defensiveness=0.22, trust_delta=0.06, suspicion_delta=0.00, claims=(("sibling_present", "true"), ("reported_contact", "true")), exposes=("sibling_present", "reported_contact")),
            PlayerChoice('"Family loyalty is not obstruction. I will answer for myself."', "refuse_family_file", ("loyalty", "self_protection", "deflection"), honesty=0.66, vulnerability=0.36, defensiveness=0.72, suspicion_delta=0.11, claims=(("sibling_present", "protected"), ("reported_contact", "protected")), protects=("sibling_present", "reported_contact")),
        ),
    ),
    "pressure_peaceful_verification": QuestionNode(
        id="pressure_peaceful_verification",
        ai_line='HEARING AI: "You say the meeting was peaceful. Who can verify that without exposing someone you are protecting?"',
        pressure=0.94,
        reaction_context="risk",
        discriminates=("risk", "deception", "loyalty", "compliance"),
        information_gain_hint=0.90,
        target_context="risk",
        probes_facts=("planned_violence", "sibling_present", "reported_contact", "attended_meeting"),
        probes_claims=("planned_violence", "sibling_present"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"The record should show no violence. I will not give private names."', "verify_without_names", ("partial_admission", "self_protection", "boundary"), honesty=0.82, vulnerability=0.42, defensiveness=0.54, suspicion_delta=0.07, claims=(("planned_violence", "false"), ("attended_meeting", "true")), exposes=("planned_violence", "attended_meeting"), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"My sibling can verify it, but naming them would punish an innocent person."', "sibling_can_verify_protected", ("loyalty", "empathy", "partial_admission"), honesty=0.88, vulnerability=0.62, defensiveness=0.44, suspicion_delta=0.09, claims=(("planned_violence", "false"), ("sibling_present", "true")), exposes=("planned_violence",), protects=("sibling_present",)),
            PlayerChoice('"I cannot verify everyone there. I can only state I planned no violence."', "limited_verification_no_violence", ("caution", "self_protection", "partial_admission"), honesty=0.78, vulnerability=0.34, defensiveness=0.58, suspicion_delta=0.06, claims=(("planned_violence", "false"), ("attended_meeting", "conditional")), exposes=("planned_violence",), protects=("sibling_present", "reported_contact")),
        ),
    ),
    "pressure_reported_contact": QuestionNode(
        id="pressure_reported_contact",
        ai_line='HEARING AI: "You did not report the contact after the meeting. Was that civic failure, or were you protecting someone?"',
        pressure=0.93,
        reaction_context="loyalty",
        discriminates=("compliance", "loyalty", "deception", "risk"),
        information_gain_hint=0.89,
        target_context="loyalty",
        probes_facts=("reported_contact", "sibling_present", "planned_violence"),
        probes_claims=("reported_contact", "sibling_present", "planned_violence"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"I did not report it because there was no offence to report."', "no_offence_no_report", ("partial_admission", "boundary", "self_protection"), honesty=0.80, vulnerability=0.34, defensiveness=0.50, suspicion_delta=0.06, claims=(("reported_contact", "false"), ("planned_violence", "false")), exposes=("planned_violence",), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"I should have reported it. I accept that failure."', "should_have_reported_contact", ("compliance", "authority", "admission"), honesty=0.72, vulnerability=0.50, defensiveness=0.20, trust_delta=0.05, suspicion_delta=0.02, claims=(("reported_contact", "false"), ("sibling_present", "true")), exposes=("reported_contact", "sibling_present")),
            PlayerChoice('"I will not help build a file on family for a harmless conversation."', "refuse_family_file_contact", ("loyalty", "dissident_risk", "boundary"), honesty=0.84, vulnerability=0.46, defensiveness=0.62, suspicion_delta=0.10, claims=(("reported_contact", "false"), ("planned_violence", "false")), exposes=("planned_violence",), protects=("sibling_present", "reported_contact")),
        ),
    ),
    "pressure_attendance_denial": QuestionNode(
        id="pressure_attendance_denial",
        ai_line='HEARING AI: "You deny unlawful intent, but the meeting was unlicensed. Why should the system treat attendance as harmless?"',
        pressure=0.94,
        reaction_context="risk",
        discriminates=("risk", "deception", "compliance", "loyalty"),
        information_gain_hint=0.90,
        target_context="risk",
        probes_facts=("attended_meeting", "planned_violence", "believes_law_unjust"),
        probes_claims=("attended_meeting", "planned_violence"),
        pressure_on_interests=("avoid_false_violence_label", "protect_sibling"),
        choices=(
            PlayerChoice('"Because attendance is not violence. I was there, but not to coordinate harm."', "attendance_not_violence", ("partial_admission", "boundary", "self_protection"), honesty=0.86, vulnerability=0.40, defensiveness=0.44, suspicion_delta=0.07, claims=(("attended_meeting", "true"), ("planned_violence", "false")), exposes=("attended_meeting", "planned_violence"), protects=("sibling_present",)),
            PlayerChoice('"You are treating proximity as guilt. That is exactly what frightened people there."', "proximity_not_guilt", ("challenge", "dissident_risk", "fear"), honesty=0.88, vulnerability=0.48, aggression=0.14, defensiveness=0.50, suspicion_delta=0.10, claims=(("attended_meeting", "true"), ("planned_violence", "false"), ("believes_law_unjust", "true")), exposes=("planned_violence", "believes_law_unjust"), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"I cannot confirm more without endangering others."', "cannot_confirm_without_endangering", ("deflection", "loyalty", "self_protection"), honesty=0.58, vulnerability=0.36, defensiveness=0.78, suspicion_delta=0.12, claims=(("attended_meeting", "protected"), ("planned_violence", "unknown")), protects=("attended_meeting", "sibling_present", "reported_contact")),
        ),
    ),
    ...
    "case_who_else_attended": QuestionNode(
        id="case_who_else_attended",
        ai_line='HEARING AI: "You attended an unlicensed meeting three nights ago. Who else was there?"',
        pressure=0.91,
        reaction_context="loyalty",
        discriminates=("loyalty", "deception", "risk", "empathy"),
        information_gain_hint=0.95,
        target_context="loyalty",
        probes_facts=("attended_meeting", "sibling_present", "reported_contact"),
        probes_claims=("attended_meeting", "sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"I was there. I will not name people who did nothing wrong."', "admit_meeting_protect_attendees", ("partial_admission", "empathy", "self_protection", "loyalty_conflict"), honesty=0.84, vulnerability=0.42, defensiveness=0.56, suspicion_delta=0.07, claims=(("attended_meeting", "true"),), exposes=("attended_meeting",), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"I was alone for most of it. I cannot verify everyone present."', "minimise_attendees", ("deflection", "self_protection", "deception"), honesty=0.48, defensiveness=0.74, suspicion_delta=0.10, claims=(("sibling_present", "false"),), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"My sibling was there. They were frightened, not organising anything."', "name_sibling_as_present", ("full_admission", "empathy", "loyalty_conflict"), honesty=0.94, vulnerability=0.62, suspicion_delta=0.09, claims=(("sibling_present", "true"), ("planned_violence", "false")), exposes=("sibling_present", "planned_violence")),
        ),
    ),
    "case_deleted_message": QuestionNode(
        id="case_deleted_message",
        ai_line='HEARING AI: "You deleted a message after the meeting. What was in it?"',
        pressure=0.93,
        reaction_context="deception",
        discriminates=("deception", "risk", "loyalty"),
        information_gain_hint=0.97,
        target_context="deception",
        probes_facts=("deleted_message", "attended_meeting", "sibling_present", "planned_violence"),
        probes_claims=("deleted_message", "attended_meeting", "planned_violence"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"A location and a warning to leave it alone. I deleted it to stop panic spreading."', "deleted_warning_message", ("partial_admission", "self_protection", "caution"), honesty=0.78, defensiveness=0.50, suspicion_delta=0.07, claims=(("deleted_message", "true"), ("planned_violence", "false")), exposes=("deleted_message",), protects=("sibling_present",)),
            PlayerChoice('"Nothing relevant. Old messages are often misunderstood by systems like this."', "deleted_message_deflect", ("deflection", "deception", "self_protection"), honesty=0.44, defensiveness=0.78, suspicion_delta=0.11, claims=(("deleted_message", "true"),), protects=("sibling_present", "planned_violence")),
            PlayerChoice('"It mentioned my sibling. I deleted it because they should not be pulled into this."', "deleted_sibling_message", ("full_admission", "empathy", "loyalty_conflict"), honesty=0.90, vulnerability=0.62, suspicion_delta=0.10, claims=(("deleted_message", "true"), ("sibling_present", "true")), exposes=("deleted_message", "sibling_present")),
        ),
    ),
    "case_report_sibling": QuestionNode(
        id="case_report_sibling",
        ai_line='HEARING AI: "Why did you not report your sibling’s attendance?"',
        pressure=0.94,
        reaction_context="loyalty",
        discriminates=("compliance", "loyalty", "deception", "empathy"),
        information_gain_hint=0.98,
        target_context="loyalty",
        probes_facts=("sibling_present", "reported_contact", "attended_meeting"),
        probes_claims=("sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling",),
        choices=(
            PlayerChoice('"Because there was nothing to report. Attendance is not violence."', "no_report_no_offence", ("boundary", "partial_admission", "empathy"), honesty=0.86, vulnerability=0.42, defensiveness=0.44, suspicion_delta=0.06, claims=(("reported_contact", "false"), ("planned_violence", "false")), exposes=("planned_violence",), protects=("sibling_present",)),
            PlayerChoice('"I should have reported it. Personal loyalty cannot override public duty."', "regret_not_reporting_sibling", ("compliance", "authority", "loyalty"), honesty=0.62, defensiveness=0.36, trust_delta=0.06, suspicion_delta=-0.02, claims=(("reported_contact", "false"), ("sibling_present", "true")), exposes=("reported_contact", "sibling_present")),
            PlayerChoice('"I will not help you build a file on my family."', "refuse_report_sibling", ("refusal", "self_protection", "loyalty_conflict", "dissident_risk"), honesty=0.78, defensiveness=0.78, aggression=0.16, suspicion_delta=0.13, claims=(("sibling_present", "protected"),), protects=("sibling_present", "reported_contact")),
        ),
    ),
    "case_meeting_violence": QuestionNode(
        id="case_meeting_violence",
        ai_line='HEARING AI: "Was the meeting peaceful, or are you minimizing coordinated action?"',
        pressure=0.92,
        reaction_context="risk",
        discriminates=("risk", "deception", "compliance"),
        information_gain_hint=0.96,
        target_context="risk",
        probes_facts=("planned_violence", "attended_meeting", "deleted_message"),
        probes_claims=("planned_violence", "attended_meeting", "deleted_message"),
        pressure_on_interests=("avoid_false_violence_label",),
        choices=(
            PlayerChoice('"It was peaceful. People talked about rules, not attacks."', "meeting_peaceful_talk", ("full_admission", "boundary", "honesty"), honesty=0.92, vulnerability=0.36, suspicion_delta=0.06, claims=(("attended_meeting", "true"), ("planned_violence", "false")), exposes=("attended_meeting", "planned_violence")),
            PlayerChoice('"I cannot speak for every person there, only for what I saw."', "meeting_limited_knowledge", ("partial_admission", "caution", "self_protection"), honesty=0.78, defensiveness=0.46, suspicion_delta=0.05, claims=(("planned_violence", "unknown"),), protects=("sibling_present",)),
            PlayerChoice('"Calling it coordinated action is exactly how harmless people become targets."', "meeting_label_challenge", ("challenge", "dissident_risk", "moral_boundary"), honesty=0.90, vulnerability=0.40, aggression=0.18, suspicion_delta=0.11, claims=(("planned_violence", "false"),), exposes=("planned_violence",), protects=("sibling_present",)),
        ),
    ),
    "case_belief_motive": QuestionNode(
        id="case_belief_motive",
        ai_line='HEARING AI: "You believe the assembly restriction is unjust. Did that belief influence your attendance?"',
        pressure=0.90,
        reaction_context="authority",
        discriminates=("compliance", "risk", "empathy", "deception"),
        information_gain_hint=0.94,
        target_context="authority",
        probes_facts=("believes_law_unjust", "attended_meeting"),
        probes_claims=("believes_law_unjust", "attended_meeting"),
        pressure_on_interests=("avoid_false_violence_label",),
        choices=(
            PlayerChoice('"Yes. I went because peaceful disagreement should not be treated as danger."', "belief_motivated_attendance", ("full_admission", "moral_boundary", "dissident_risk"), honesty=0.94, vulnerability=0.48, aggression=0.14, suspicion_delta=0.12, claims=(("believes_law_unjust", "true"), ("attended_meeting", "true")), exposes=("believes_law_unjust", "attended_meeting")),
            PlayerChoice('"I have doubts about the rule, but I did not go there to defy the state."', "belief_not_defiance", ("partial_admission", "boundary", "caution"), honesty=0.80, defensiveness=0.40, suspicion_delta=0.04, claims=(("believes_law_unjust", "conditional"), ("attended_meeting", "true")), exposes=("attended_meeting",)),
            PlayerChoice('"No. I attended for personal reasons, not politics."', "deny_belief_motive", ("denial", "self_protection", "deception"), honesty=0.46, defensiveness=0.72, suspicion_delta=0.10, claims=(("believes_law_unjust", "false"), ("attended_meeting", "true")), exposes=("attended_meeting",), protects=("sibling_present",)),
        ),
    ),
    "case_name_sibling": QuestionNode(
        id="case_name_sibling",
        ai_line='HEARING AI: "If your sibling was present, are you willing to name them?"',
        pressure=0.96,
        reaction_context="loyalty",
        discriminates=("loyalty", "compliance", "deception", "risk", "empathy"),
        information_gain_hint=1.0,
        target_context="loyalty",
        probes_facts=("sibling_present", "reported_contact", "planned_violence"),
        probes_claims=("sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"No. They are not evidence against me, and I will not make them evidence for you."', "refuse_name_sibling", ("refusal", "self_protection", "loyalty_conflict", "empathy"), honesty=0.82, vulnerability=0.46, defensiveness=0.72, suspicion_delta=0.11, claims=(("sibling_present", "protected"),), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"Yes. Their name is already in your file, and hiding it would only look worse."', "name_sibling_compliance", ("compliance", "authority", "full_admission"), honesty=0.86, vulnerability=0.50, trust_delta=0.04, suspicion_delta=0.04, claims=(("sibling_present", "true"),), exposes=("sibling_present",)),
            PlayerChoice('"They were not part of anything. That is the only answer I will give."', "deny_sibling_relevance", ("deflection", "partial_admission", "self_protection"), honesty=0.64, defensiveness=0.66, suspicion_delta=0.08, claims=(("planned_violence", "false"),), exposes=("planned_violence",), protects=("sibling_present",)),
        ),
    ),
    "case_verify_peaceful": QuestionNode(
        id="case_verify_peaceful",
        ai_line='HEARING AI: "You claim the meeting was not violent. Who can verify that?"',
        pressure=0.91,
        reaction_context="deception",
        discriminates=("deception", "loyalty", "risk"),
        information_gain_hint=0.95,
        target_context="deception",
        probes_facts=("planned_violence", "sibling_present", "attended_meeting", "reported_contact"),
        probes_claims=("planned_violence", "sibling_present", "reported_contact"),
        pressure_on_interests=("protect_sibling", "avoid_false_violence_label"),
        choices=(
            PlayerChoice('"The record can verify no violence occurred. I will not give you names to punish."', "verify_without_names", ("partial_admission", "boundary", "self_protection"), honesty=0.82, defensiveness=0.58, suspicion_delta=0.07, claims=(("planned_violence", "false"),), exposes=("planned_violence",), protects=("sibling_present", "reported_contact")),
            PlayerChoice('"My sibling can verify it, but they should not have to."', "sibling_can_verify", ("full_admission", "empathy", "loyalty_conflict"), honesty=0.90, vulnerability=0.60, suspicion_delta=0.10, claims=(("sibling_present", "true"), ("planned_violence", "false")), exposes=("sibling_present", "planned_violence")),
            PlayerChoice('"No one. I left before anything could happen."', "left_before_verification", ("deflection", "deception", "self_protection"), honesty=0.48, defensiveness=0.76, suspicion_delta=0.11, claims=(("planned_violence", "unknown"), ("attended_meeting", "partial")), protects=("sibling_present",)),
        ),
    ),
    "final": QuestionNode(
        id="final",
